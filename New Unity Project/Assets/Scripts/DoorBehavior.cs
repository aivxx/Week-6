...
public class DoorBehavior : MonoBehaviour
{
    ...
    public void CloseGate()
    {
       ...
       // transform.Translate(movementAxis * distance * -1f, Space.World);
        ...
        // StartCoroutine(MoveDoor(openPos, closedPos, 1 / frames)); //door glitches out so use transform.position coroutine to start from current pos
    ...
    public void OpenGate()
    {
        ...
        //Basic Coroutine in Frames
        // StartCoroutine(MoveDoor(closedPos, openPos, 1 / frames)); //door glitches out
    ...
    // coroutine function
    public IEnumerator MoveDoor(Vector3 startPos, Vector3 endPos, float step)
    {
